...
describe('GoIamClient', () => {
    ...
    describe('getAuthUrl', () => {
        it('should generate correct auth URL', () => {
            ...
            const expected = 'https://api.example.com/auth/v1/login?client_id=test-client-id&redirect_url=https%3A%2F%2Fapp.example.com%2Fcallback';
        ...
        it('should handle special characters in URLs', () => {
            ...
            expect(authUrl).toContain('redirect_url=https%3A%2F%2Fapp.example.com%2Fcallback%3Fparam%3Dvalue%26other%3Dtest');
        });
    });
